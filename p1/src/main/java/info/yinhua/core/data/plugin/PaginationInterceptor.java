package info.yinhua.core.data.plugin;
 ...
 * 老规矩，签名里要拦截的类型只能是接口。
 * @see http://www.cnblogs.com/zemliu/p/3242966.html
 * @see http://blog.csdn.net/hupanfeng/article/details/9265341
 * @see http://blog.csdn.net/hupanfeng/article/details/16950161
 * @see https://github.com/hupanfeng/hdd/blob/master/hdd_common/src/main/java/com/hdd/common/mybatis/page/PageInterceptor.java
 */
...
public class PaginationInterceptor implements Interceptor {
    ...
    private static final String DEFAULT_DIALECT = "mysql"; // 需要拦截的ID(正则匹配)
