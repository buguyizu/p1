	...
	public void onAuthenticationFailure(HttpServletRequest request,
		...
		if (defaultFailureUrl == null) {
			...
			if (forwardToDestination) {
				...
				//start 2016/07/22
				request.getSession().setAttribute(CommonConst.KEY_USERNAME, request.getParameter(CommonConst.KEY_USERNAME));
				request.getSession().setAttribute(CommonConst.KEY_REMEMBER, request.getParameter(CommonConst.KEY_REMEMBER));
				//end 
